                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="footer-widget">
                            ...
                            <ul class="listnone contact">
                                <li><i class="fa fa-map-marker"></i> 1084,Chandgaon Police Station,Shah Amanat Bridge Connecting Road, Chittagong</li>
                                <li><i class="fa fa-phone"></i> +88-031-2555721-24</li>
                                <li><i class="fa fa-fax"></i> +88-01707-507070</li>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="copyright-content">
                                <p>All rights reserved-2023 © Developed by: S.M.Murshed Manik</p>
                            </div>
                        </div>
                    </div>
                </div>
